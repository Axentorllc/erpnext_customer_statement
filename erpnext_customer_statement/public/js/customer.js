            ...
            var customer_statement_dialog = new frappe.ui.Dialog({
              ...
              primary_action: function () {
                ...
                var url =
                  ...
                  "/api/method/erpnext_customer_statement.customer_statement.customer_statement.get_report_pdf?from_date=" +
                  encodeURIComponent(values.from_date) +
                  "&to_date=" +
                  encodeURIComponent(values.to_date) +
                  "&company=" +
                  encodeURIComponent(values.company) +
                  "&customer=" +
